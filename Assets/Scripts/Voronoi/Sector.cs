...
namespace Pathfinder.Voronoi
{
        ...
        where TCoordinateType : IEquatable<TCoordinateType>
    {
        ...
        public void SetIntersections(TCoordinate mapSize)
        {
            intersections.Clear();
            ...
            for (int i = 0; i < segments.Count; i++)
            {
                for (int j = 0; j < segments.Count; j++)
                {
                    ...
                    TCoordinate intersectionPoint = GetIntersection(segments[i], segments[j], mapSize);
        ...
        private TCoordinate GetIntersection(Segment<TCoordinate, TCoordinateType> seg1, Segment<TCoordinate, TCoordinateType> seg2, TCoordinate mapSize)
        {
        ...
        private void SortIntersections()
        {
            ...
            center.SetCoordinate((int)(minX + (maxX - minX) / 2), (int)(minY + (maxY - minY) / 2));
